...
# Задача1 / 2
#Сейчас функция сортирует всегда по убыванию. Добавьте возможность сортировки по возрастанию. Для этого допишите в функцию ещё один аргумент. Он должен иметь такой же смысл, как аргумент reverse метода sort(): принимать значение False, если нужно сортировать в обычном порядке, и True – если в обратном. Для этого допишите в функцию ещё один аргумент с именем reverse.

#После добавления нового аргумента написанные ранее вызовы функций перестанут работать. Чтобы их починить, передайте им третий аргумент. Затем выведите на экран 5 самых коротких фильмов из таблицы.
