...
#Задача2 / 2
#Отсортируйте таблицу по столбцу «Твиттер, млн» по убыванию и выведите её в наглядном формате (см. прекод). Обратите внимание, какие эмодзи наиболее популярны на этой платформе. Какой артефакт (необычный объект) выделяется особо?
