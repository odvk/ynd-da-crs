...
#Задача1 / 2
#Отсортируйте таблицу по столбцу «Instagram, млн» по убыванию и выведите её в наглядном формате (см. прекод). Обратите внимание, какие эмодзи наиболее популярны на этой платформе.
