#6. Функции как инструмент организации кода
...
#Одна из важнейших коммерческих характеристик кинокартины — её окупаемость, или ROI (от англ. return on investment, «прибыль на инвестированный капитал»). Окупаемость показывает, какую прибыль принёс каждый инвестированный доллар. Вычисляется ROI по формуле:
