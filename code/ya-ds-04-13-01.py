#Операторы and и or
#Задача1 / 2
#Напишите функцию filter_suspense() (англ. filter suspense, «отобрать напряжённое»), которая находит фильмы самых напряжённых жанров: «триллер» и «ужасы». Функция должна принимать как аргумент исходную таблицу и, не меняя её, возвращать отфильтрованную.
