...
#Сохраните её в переменной genres_means (англ. genres means, «средние значения по жанрам») и выведите на экран. Числа печатайте с двумя знаками после запятой и выравнивайте по правому краю, а названия — по левому. В прекоде вывод уже описан.
