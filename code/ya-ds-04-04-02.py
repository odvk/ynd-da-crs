...
average_expenses_per_person = column_sum(oscar_data, 6)/total_people

print('Каждый человек в среднем потратил ${:.2f} на фильмы, получившие "Оскар".'.format(average_expenses_per_person))
