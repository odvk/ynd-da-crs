#Операторы and и or
#Задача2 / 2
#Для анализа фильмов по годам нам нужно научиться выделять из таблицы диапазоны: например с 2000 по 2010 год. Напишите функцию filter_first_decade() (англ. filter first decade, «отобрать первую декаду»), которая фильтрует таблицу по этому условию. Функция должна получать на вход исходную таблицу и, не меняя её, возвращать отфильтрованную.
