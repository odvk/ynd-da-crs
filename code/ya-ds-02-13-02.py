...
# Для всех топовых эмодзи посчитайте, сколько в среднем сообщений в EmojiXpress отправляется с ними (в миллионах). Выведите результат на экран с точностью до двух знаков после запятой.
...
mean_emojixpress = sum_emojixpress / size
