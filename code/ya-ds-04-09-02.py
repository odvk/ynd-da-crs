...
#Одни жанры встречаются чаще других. Давайте найдём самые популярные. Создайте таблицу и сохраните её в переменной genres_counts (англ. genres counts, «счётчики жанров»). Она должна состоять из двух столбцов: «название жанра» и «количество фильмов с ним».

#Все жанры мы собрали в переменной all_genres (англ. all genres, «все жанры»). Наполните таблицу данными. Отсортируйте столбец «количество» по убыванию. 

#Мы уже написали код для вывода в таком формате:
...
# Создайте таблицу (список списков) со столбцами 
# "название жанра" и "количество фильмов с ним".
# Назовите переменную genres_counts.
genres_counts = []
for genre in all_genres:
    ...
    count = len(filtered_data) #<---------- < напишите код здесь >
