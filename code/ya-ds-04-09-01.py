#Оператор in
#Задача1 / 2
#Отфильтруем же таблицу по жанру! Для этой цели напишите функцию filter_by_genre() (англ. filter by genre, «фильтровать по жанру»). Она должна иметь два аргумента: таблицу с данными и название жанра. А возвращать — новую таблицу с фильмами переданного жанра.
...
filtered_data = filter_by_genre(oscar_data, 'мелодрама') # <---- < напишите код здесь >
